...
// Assembly: Stardew Valley, Version=1.6.8.24119, Culture=neutral, PublicKeyToken=null
// MVID: 6C4A12A7-5B18-47F7-A741-EE55E7EFED8D
...
namespace StardewValley.Menus
{
    public class CraftingPage : IClickableMenu
    {
          ...
          : base(x, y, width, height)
        {
            ...
            ClickableTextureComponent textureComponent = new ClickableTextureComponent(new Rectangle(this.xPositionOnScreen + width + 4, this.yPositionOnScreen + height - 192 - 32 - IClickableMenu.borderWidth - 104, 64, 104), Game1.mouseCursors, new Rectangle(564 + Game1.player.trashCanLevel * 18, 102, 18, 26), 4f);
        ...
        private void layoutRecipes(List<string> playerRecipes)
        {
            ...
            foreach (string playerRecipe in playerRecipes)
            {
                ...
                ParsedItemData dataOrErrorItem = ItemRegistry.GetDataOrErrorItem(recipe.bigCraftable ? "(BC)" + indexOfMenuView : indexOfMenuView);
                Texture2D texture = dataOrErrorItem.GetTexture();
                Rectangle sourceRect = dataOrErrorItem.GetSourceRect();
                ClickableTextureComponent textureComponent = new ClickableTextureComponent("", new Rectangle(num1 + x * (64 + num2), this.craftingPageY() + y * 72, 64, recipe.bigCraftable ? 128 : 64), (string)null, !this.cooking || Game1.player.cookingRecipes.ContainsKey(recipe.name) ? "" : "ghosted", texture, sourceRect, 4f);
        ...
        public virtual void RepositionElements()
        {
            ...
            {
                ClickableTextureComponent textureComponent1 = new ClickableTextureComponent(new Rectangle(this.xPositionOnScreen + 768 + 32, this.craftingPageY(), 64, 64), Game1.mouseCursors, Game1.getSourceRectForStandardTileSheet(Game1.mouseCursors, 12), 0.8f);
                ...
                ClickableTextureComponent textureComponent2 = new ClickableTextureComponent(new Rectangle(this.xPositionOnScreen + 768 + 32, this.craftingPageY() + 192 + 32, 64, 64), Game1.mouseCursors, Game1.getSourceRectForStandardTileSheet(Game1.mouseCursors, 11), 0.8f);
            ...
            this.trashCan.bounds.Y = this.yPositionOnScreen + this.height - 192 - 32 - IClickableMenu.borderWidth - 104;
            this.dropItemInvisibleButton.bounds.X = this.xPositionOnScreen - IClickableMenu.borderWidth - IClickableMenu.spaceToClearSideBorder - 64;
            this.dropItemInvisibleButton.bounds.Y = this.trashCan.bounds.Y;
            if (this.upButton != null)
            {
                this.upButton.bounds.X = this.xPositionOnScreen + 768 + 32;
                this.upButton.bounds.Y = this.craftingPageY();
            }
            if (this.downButton != null)
            {
                this.downButton.bounds.X = this.xPositionOnScreen + 768 + 32;
        ...
        public override void draw(SpriteBatch b)
        {
            ...
            IClickableMenu.drawHoverText(b, " ", Game1.smallFont, this.heldItem != null ? 48 : 0, this.heldItem != null ? 48 : 0, boldTitleText: this.hoverRecipe.DisplayName + (this.hoverRecipe.numberProducedPerCraft > 1 ? " x" + this.hoverRecipe.numberProducedPerCraft.ToString() : ""), buffIconsToDisplay: buffIconsToDisplay, hoveredItem: this.lastCookingHover, craftingIngredients: this.hoverRecipe, additional_craft_materials: this.getContainerContents());
        }
